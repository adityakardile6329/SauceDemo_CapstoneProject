...
public class LoginSteps {
    ...
    public void user_should_be_redirected_to_inventory_page() {
        ...
        try {
            ...
            ScreenShotUtils.takeScreenshot(driver, "LoginFailed");
            throw e;
        } finally {
    ...
    public void error_message_should_be_displayed(String expectedMessage) {
        ...
        try {
            ...
            ScreenShotUtils.takeScreenshot(driver, "ErrorMessage");
        } catch (AssertionError e) {
            ScreenShotUtils.takeScreenshot(driver, "ErrorMessageFailed");
            throw e;
        } finally {
            DriverFactory.quitDriver();
            extent.flush();
    ...
    public void user_should_be_on_login_page() {
        ...
        try {
            ...
            ScreenShotUtils.takeScreenshot(driver, "LogoutSuccess");
        } catch (AssertionError e) {
            ScreenShotUtils.takeScreenshot(driver, "LogoutFailed");
            throw e;
        } finally {
            DriverFactory.quitDriver();
            extent.flush();
